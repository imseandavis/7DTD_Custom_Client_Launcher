...
<#
    ...
    --------------------------------------------------------------------------------
     ...
     Generated on:       8/18/2021 4:34 PM
     Generated by:       imsea
    --------------------------------------------------------------------------------
    .DESCRIPTION
...
"@ -IgnoreWarnings | Out-Null
	...
	$buttonConnectToCindarsWorl_Click={
		...
		try
		{
			...
			$progressbaroverlay1.TextOverlay = "Downloading Latest Client Side Mode Files";
			$progressbaroverlay1.PerformStep();
			...
			$progressbaroverlay1.PerformStep();
			$ModVerisonFolderName = (Get-ChildItem "$7DTDPath\Mods" -Directory | Select -First 1).Name
			...
			{
				"Error Couldn't Find The File, But It Should Have Been There!"
			}
		}
		catch
		{
